  ...
  return (
    <div className='registermain grid grid-cols-2 max-h-screen overflow-hidden'>
      ...
      <div className='video-register relative'>
        <video className='h-screen' style={{width:"100%",objectFit:'cover'}} src='https://videos.pexels.com/video-files/4125025/4125025-uhd_2560_1440_24fps.mp4' autoPlay loop muted playsInline/>
      ...
      <div className='registerfields mt-10 p-10 overflow-auto max-h-[calc(90vh)] overflow-auto'>
        ...
        <div style={{width:"fit-content"}}>
          <h1 className='text-left mt-10 text-3xl font-bold lg:text-4xl xl:text-5xl'>Welcome Back to GlobeTales</h1>
