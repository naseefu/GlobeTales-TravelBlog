  ...
  return (
    <div className='registermain grid grid-cols-2 max-h-screen overflow-hidden'>
      ...
      <div className='video-register relative'>
        <video className='h-screen' style={{width:"100%",objectFit:'cover'}} src='https://videos.pexels.com/video-files/29393001/12660649_1920_1080_60fps.mp4' autoPlay loop muted playsInline/>
      ...
      <div className='registerfields mt-10 p-10 pt-0 overflow-auto max-h-[calc(90vh)] overflow-auto'>
        <div>
          ...
          <h1 className='text-left flex items-center gap-3 text-1xl font-bold'>
            <span><img className='rounded-lg' src={logo} style={{height:"30px"}} alt='logo'/></span> GlobeTales
          </h1>

        </div>

        <div style={{width:"fit-content"}}>
          <h1 className='text-left mt-10 text-3xl font-bold lg:text-4xl xl:text-5xl'>Welcome to GlobeTales</h1>
          <p className='text-left text-1xl text-gray-500 mt-3 lg:text-1xl xl:text-[calc(18px)]'>Create Your GlobeTales Account</p>
        </div>
        ...
        <div className='flex flex-col items-start mt-10 gap-10 align-start'>
          ...
          <div className='flex flex-col items-start gap-2'>
            ...
            <input className='border border-gray-200' value={password} onChange={(e)=>setPassword(e.target.value)}></input>
          </div>

          <div className='flex flex-col items-start gap-2'>
            <label>Confirm Password</label>
            <input className='border border-gray-200' value={confirmpassword} onChange={(e)=>setConfirmPassword(e.target.value)}></input>
          </div>
